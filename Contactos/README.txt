...
a persistence unit "ContactosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Contactos\pom.xml":
...
artifact ("Contactos.war") is already built. You can build
